...
export const MessageType = Object.freeze({
  ...
  LIVE_MONITORING_STATUS_GET: 'liveMonitoring:status:get',
  LIVE_MONITORING_START: 'liveMonitoring:start',
  LIVE_MONITORING_STOP: 'liveMonitoring:stop',
  LIVE_MONITORING_RECONNECT: 'liveMonitoring:reconnect',
